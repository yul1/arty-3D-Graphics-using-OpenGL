...
public class Camera {
  ...
  public static final Vec3 DEFAULT_POSITION_1 = new Vec3(25,0,10);
  public static final Vec3 DEFAULT_POSITION_2 = new Vec3(25,10,0.0f);
  ...
  public void setCamera(CameraType c) {
    switch (c) {
      ...
      case Y : setupCamera(DEFAULT_POSITION_1, DEFAULT_TARGET, DEFAULT_UP) ; break;
